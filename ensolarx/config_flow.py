...
from .const import DOMAIN, CONF_UNIT_ID, CONF_SCAN_INTERVAL, DEFAULT_HOST, DEFAULT_PORT, DEFAULT_UNIT_ID, DEFAULT_SCAN_INTERVAL
...
class EnsolarXConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input: Dict[str, Any] | None = None):
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(title=f"EnsolarX {user_input[CONF_HOST]}", data=user_input)
